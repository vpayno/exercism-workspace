...
TEST_CASE("score when eating dot") { REQUIRE(scored(false, true)); }

TEST_CASE("score when eating power pellet") { REQUIRE(scored(true, false)); }
...
TEST_CASE("win if all dots eaten") { REQUIRE(won(true, false, false)); }
