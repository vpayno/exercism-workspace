...
static void test_zero_steps_for_one(void) { TEST_ASSERT_EQUAL(0, steps(1)); }

static void test_divide_if_even(void) { TEST_ASSERT_EQUAL(4, steps(16)); }

static void test_even_and_odd_steps(void) { TEST_ASSERT_EQUAL(9, steps(12)); }
